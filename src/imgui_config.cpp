...
void configureImGuiStyle() {
  ...
  // colors[ImGuiCol_FrameBgHovered] = ImVec4(0.47f, 0.59f, 0.59f, 0.40f);
  // colors[ImGuiCol_FrameBgActive] = ImVec4(0.41f, 0.64f, 0.53f, 0.69f);
  // colors[ImGuiCol_TitleBg] = ImVec4(0.27f, 0.2f, 0.42f, 0.83f);
  ...
  // colors[ImGuiCol_Button] = ImVec4(0.35f, 0.2f, 0.49f, 0.62f);
  // colors[ImGuiCol_ButtonHovered] = ImVec4(0.40f, 0.3f, 0.57f, 0.79f);
  // colors[ImGuiCol_ButtonActive] = ImVec4(0.46f, 0.80f, 0.64f, 1.00f);
  // colors[ImGuiCol_Header] = ImVec4(0.40f, 0.1f, 0.67f, 0.45f);
